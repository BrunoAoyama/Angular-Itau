...
@Component({
  ...
  export class CadastroComponent implements OnInit {
    ...
    private pessoa:Colaborador = new Colaborador();
 
    constructor(private pessoaService: ColaboradorService,
    ...
    ngOnInit() {
      ...
      this.activatedRoute.params.subscribe(parametro=>{
        ...
        if(parametro["codigo"] == undefined){
          ...
          this.titulo = "Novo Cadastro de Colaborador";
        }
        else{
 
          this.titulo = "Editar Cadastro de Colaborador";
